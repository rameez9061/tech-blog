...
export default async function  Blogs() {
     ...
     const dataFetching = await fetch("/info.json")
        ...
        <div className="inside-blog-wrapper w-[70%] mx-auto ">
          ...
          <div className="all-blogs-div w-full grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-12 mt-3">
            {data.map((item:BlogItem)=>{
                return (
                    <div key={item.id} className="blog  h-[400px]  shadow-2xl shadow-gray-400 " style={{ borderBottomLeftRadius:"5%" , borderBottomRightRadius:"5%"}}>
                    ...
                    <div className="information mt-8 px-2">
                     ...
                     <Link href={`/Blogs/${item.id}`}><h1 className="font-bold leading-tight mt-2">The Impact of Technology on workplace How Technology is Changing</h1></Link>
